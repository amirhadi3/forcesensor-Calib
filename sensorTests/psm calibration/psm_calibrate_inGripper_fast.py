...
#recorder_fast starts recording the robot, ATI, and OFS data until the /insertion topic is set to 0

class recorder_fast(object):
    ...
    def __initATI(self):
	self.atiSensor = ati.Ati('/home/david/Documents/forcesensor', 'FT24093',0)
